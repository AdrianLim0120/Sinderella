...
$services_query = "SELECT service_id, service_name FROM service_pricing WHERE service_status = 'active'";
...
$search_sinderella = isset($_GET['search_sinderella']) ? $_GET['search_sinderella'] : '';
$search_service = isset($_GET['search_service']) ? $_GET['search_service'] : '';
$search_status = isset($_GET['search_status']) ? $_GET['search_status'] : '';

$query = "SELECT b.booking_id, b.booking_date, b.booking_from_time, b.booking_to_time, c.cust_name, s.sind_name, sp.service_name, sp.service_price, b.booking_status, b.full_address
          FROM bookings b
...
if ($search_customer) {
    $query .= " AND c.cust_name LIKE '%" . $conn->real_escape_string($search_customer) . "%'";
}

if ($search_sinderella) {
    $query .= " AND s.sind_name LIKE '%" . $conn->real_escape_string($search_sinderella) . "%'";
}

if ($search_service) {
    $query .= " AND sp.service_id = '" . $conn->real_escape_string($search_service) . "'";
}
...
<head>
    ...
    <title>View Bookings - Admin - Sinderella</title>
            ...
            <div class="profile-container">
                ...
                <form method="GET" action="" class="search-container">
                    ...
                    <div>
                        ...
                        <input type="text" id="search_customer" name="search_customer" value="<?php echo htmlspecialchars($search_customer); ?>">
                    </div>
                    <div>
                        <label for="search_sinderella">Sinderella:</label>
                    ...
                    <div>
                        ...
                        <select id="search_service" name="search_service">
                            <option value="">All</option>
                            <?php while ($service = $services_result->fetch_assoc()): ?>
                                <option value="<?php echo htmlspecialchars($service['service_id']); ?>" <?php if ($search_service == $service['service_id']) echo 'selected'; ?>>
                    ...
                    <div>
                        ...
                        <select id="search_status" name="search_status">
                            ...
                            <option value="cancelled" <?php if ($search_status == 'cancelled') echo 'selected'; ?>>Cancelled</option>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr onclick="viewBookingDetails(<?php echo $row['booking_id']; ?>)">
                                ...
                                <!-- <td>RM <?php echo number_format($row['service_price'], 2); ?></td> -->
