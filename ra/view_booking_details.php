...
$stmt->execute();
$stmt->bind_result($booking_date, $booking_from_time, $booking_to_time, $cust_name, $full_address, $sinderella_name, $service_name, $service_price, $booking_status);
$stmt->fetch();
$stmt->close();
            ...
            <div class="details-container">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($full_address); ?></td>                    </tr>
                    <tr>
