...
$query = "SELECT s.sind_id, s.sind_name, s.sind_phno, s.sind_status,
          ...
          LEFT JOIN sind_label sl ON sil.slbl_id = sl.slbl_id
          WHERE 1=1";
...
<head>
    ...
    <style>
        ...
        #add-sinderella-button, #manage-labels-button {
            margin-top: 0;
            margin-bottom: 10px;
        }
        .label-badge {
