...
$selected_address = $_POST['full_address'];

// Database connection
require_once '../db_connect.php';

// Fetch service details
$stmt = $conn->prepare("SELECT service_name, service_price, service_duration FROM service_pricing WHERE service_id = ?");
$stmt->bind_param("i", $service_id);
$stmt->execute();
$stmt->bind_result($service_name, $service_price, $service_duration);
$stmt->fetch();
$stmt->close();
